...
private:
	// Shader directory
	const std::string SHADER_DIR = "C:/Users/forev/projects/vulkan-tutorial/_edit/shaders/";
	// GLFW window
	GLFWwindow *window;
	...
	// Get required extensions for GLFW and validation layers
	...
	void createInstance()
	{
		// Check if validation layers are available when enabled
		...
		if (enableValidationLayers)
		{
			...
			// Set up debug messenger create info for instance creation
	...
	// Check if the physical device is suitable for our needs
	...
	// Check if the physical device supports all required extensions
